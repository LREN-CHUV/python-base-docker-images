...
```
FROM hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:hbpmip/python-mip-sklearn:0.2.5
...
* Extract the scripts in a proper library sub-project, publish it on PyPI and install it properly in the python-mip-sklearn image
