[![DockerHub](https://img.shields.io/badge/docker-hbpmip%python--mip-008bb8.svg)](https://hub.docker.com/r/hbpmip/python-mip/) 
...
```
FROM hbpmip/python-mip:hbpmip/python-mip:hbpmip/python-mip:0.1.2
